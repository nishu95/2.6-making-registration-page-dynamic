...
function getTodos() {
  ...
  // PUT/PATCH REQUEST
  // put will replace whole data entry to given input only
  // patch request only replace the input here and leave the rest entry untouched
  // see userid in output in case of put and patch
  function updateTodo() {
    axios
